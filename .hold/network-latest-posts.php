...
<<<<<<< HEAD
		...
		default:
			$content = $content . '<a href="' . $permalink . '">' . __( 'more', 'trans-nlp' ) . '</a>';
=======
			$content = $content . '<a href="' . $permalink . '">' . __( 'more', 'wpn-posts' ) . '</a>';
			break;
		// Image
		case 'image':
			$content = $content . '<a href="' . $permalink . '"><img src="' . plugins_url( '/img/excerpt_trail.png', __FILE__ ) . '" alt="' . __( 'more', 'wpn-posts' ) . '" title="' . __( 'more', 'wpn-posts' ) . '" /></a>';
			break;
		// Text by default
		default:
			$content = $content . '<a href="' . $permalink . '">' . __( 'more', 'wpn-posts' ) . '</a>';
...
=======
	//wp_register_sidebar_widget( 'nlposts-sb-widget', __( "Network Latest Posts", 'wpn-posts' ), "network_latest_posts_widget" );
	wp_register_widget_control( 'nlposts-control', __( "Network Latest Posts", 'wpn-posts' ), "network_latest_posts_control" );
>>>>>>> 933c84a... Initial Commit.
...
=======
	load_plugin_textdomain( 'wpn-posts', false, basename( dirname( __FILE__ ) ) . '/languages' );
>>>>>>> 933c84a... Initial Commit.
}
